...
stage_d = [None]*8
stage_d[0] = "The first stage gently introduces us to the Austrian alps, leading out of Vienna and thru a plethora of small hills to the historic (?) town of Mariazell."
